...
export default function SearchBar({ className = "" }) {
  return (
    <div
      className={`flex items-center gap-2 bg-[#F2EFE9] rounded-full px-3 py-1.5 border border-transparent focus-within:border-primary transition-colors ${className}`}
    >
